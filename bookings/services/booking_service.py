    ...
    def confirm_quote(booking: Booking) -> Booking:
        ...
        for item in quote.get('items', []):
            ...
            BookingItem.objects.create(
                ...
                status='booked',
                start_date=item.get('start_date') or item.get('startDate') or booking.guest_info.get('departureDate'),
                end_date=item.get('end_date') or item.get('endDate') or booking.guest_info.get('returnDate'),
                start_time=item.get('start_time') or item.get('startTime'),
                end_time=item.get('end_time') or item.get('endTime'),
                is_round_trip=item.get('is_round_trip') or item.get('isRoundTrip', False),
    ...
    def process_submission(data: dict, request_user=None) -> Booking:
        ...
        for item in items_data:
            ...
            booking_item = BookingItem.objects.create(
                ...
                start_date=item.get('start_date') or item.get('startDate') or data.get('departureDate'),
                end_date=item.get('end_date') or item.get('endDate') or data.get('returnDate') or (item.get('start_date') or item.get('startDate') or data.get('departureDate')),
                start_time=item.get('start_time') or item.get('startTime'),
                end_time=item.get('end_time') or item.get('endTime'),
                is_round_trip=item.get('is_round_trip') or item.get('isRoundTrip', False),
                return_date=item.get('return_date') or item.get('returnDate'),
